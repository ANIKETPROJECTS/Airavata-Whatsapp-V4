      ...
      <div className="flex h-screen bg-gray-50 text-slate-900 overflow-hidden">
        ...
        >
          ...
          <button
            ...
            className="absolute -right-2 top-1/2 -translate-y-1/2 w-3.5 h-3.5 bg-white border border-gray-300 rounded-full flex items-center justify-center shadow-sm hover:shadow-md hover:border-gray-500 transition-all z-30 text-gray-800 hover:text-black"
          >
            {collapsed
