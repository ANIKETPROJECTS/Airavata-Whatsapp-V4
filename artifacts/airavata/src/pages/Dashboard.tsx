      ...
      <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl p-6 border border-primary/10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#1877F2] text-white font-medium rounded-lg shadow-sm hover:bg-[#1877F2]/90 flex items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {fbConnecting ? (
